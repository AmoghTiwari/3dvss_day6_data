...
def find_dynamic_lmk_idx_and_bcoords(vertices, pose, dynamic_lmk_faces_idx,
    ...
    aa_pose = torch.index_select(pose.reshape(batch_size, -1, 3), 1,
                                 neck_kin_chain)
    rot_mats = batch_rodrigues(
        aa_pose.reshape(-1, 3), dtype=dtype).reshape(batch_size, -1, 3, 3)
...
def lbs(betas, pose, v_template, shapedirs, posedirs, J_regressor, parents,
    ...
    if pose2rot:
        ...
        pose_offsets = torch.matmul(pose_feature.reshape(batch_size, -1),
